...
void Mars::colonization(){
    std::cout <<"Speaking of space travel, when does Elon Musk (founder of SpaceX) expect to send humans to Mars?\n" <<std::endl;
    std::string answer = "";
    for (;;) {
    std::cout << "\n\n\[A] 2023\
\n[B] 2026\
\n[C] 2040\n";
  ...
  std::cout << "That's right!  Musk has stated his main goal behind SpaceX is laying the groundwork for an interplanetary\
